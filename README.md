# Andrei Arnautov — portfolio

Static production portfolio built with Astro.
...
This repository contains only the approved public site, optimized web media and deployment code. Private source materials must never be copied here.
